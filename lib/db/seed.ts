      ...
      await tx
        ...
        .onConflictDoUpdate({
          ...
          set: {
            ...
            trial_end_field_status: subscription.trial_end_field_status,
            auto_renewal_field_status: subscription.auto_renewal_field_status,
            ...
            trial_end_confidence: subscription.trial_end_confidence,
            auto_renewal_confidence: subscription.auto_renewal_confidence,
