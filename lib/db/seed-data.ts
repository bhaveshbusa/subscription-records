...
export function getSeedDates(today: Date) {
  return {
    ...
    trialEndsLater: dateAtOffset(today, 14),
...
export function createSeedData(
  ...
  const subscriptionRows = {
    ...
    notion: {
      ...
      ends_on: null,
      notes: "Trial with unknown paid-plan terms. Monthly cadence does not confirm auto-renewal.",
      provider_field_status: "confirmed",
      ...
      status_confidence: "high",
      deferred_until: null,
      trial_ends_on: dates.trialEndsOn,
      trial_end_field_status: "proposed",
      trial_end_confidence: "medium",
      auto_renewal: null,
      auto_renewal_field_status: "empty",
      auto_renewal_confidence: null,
    },
    ...
    /**
     * A free trial with a stated paid plan after trial. Amount is not a current
     * charge. Auto-renewal stays unknown even though cadence is monthly.
     */
    canva: {
      key: "canva",
      id: SEED_SUBSCRIPTION_IDS.canva,
      user_id: SEED_USER_ID,
      provider_canonical: "canva",
      provider_display: "Canva",
      plan: "Pro trial",
      account_hint: null,
      status: "trial",
      amount_minor: 1000,
      ...
      cadence: "monthly",
      next_renewal: null,
      started_on: dateAtOffset(today, -5),
      ends_on: null,
      notes: "Paid plan after trial. The trial itself has no charge.",
      provider_field_status: "confirmed",
      amount_field_status: "confirmed",
      cadence_field_status: "confirmed",
      renewal_field_status: "empty",
      ...
      status_confidence: "high",
      deferred_until: null,
      trial_ends_on: dates.trialEndsLater,
