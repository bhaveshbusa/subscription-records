...
The compact UI from SUB-72–SUB-78 has a separate comparison sign-off, [SUB-79](https://linear.app/lets-play-match/issue/SUB-79/validate-the-new-ui-with-comparison-tasks-and-record-human-sign-off). That record is [validation/sub-79-ui-signoff.md](validation/sub-79-ui-signoff.md) and is awaiting human SIGN-OFF. It does not reopen SUB-63.
