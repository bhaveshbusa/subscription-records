...
This file began as a discussion draft on 7 September 2026. Decisions from that discussion are now captured in [product.md](product.md) and [user-journeys.md](user-journeys.md); those current documents supersede the draft's proposed implementation sequence and unresolved options. Money, date, trust and lifecycle rules are defined in [AGENTS.md](../AGENTS.md).

The product helps a person maintain an inventory of subscriptions they hold, what those subscriptions cost and when the next payment is due. The user brings messy evidence and the system proposes understandable changes for review. It does not record payments or infer a lifecycle change from silence.
